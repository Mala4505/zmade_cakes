 ...
 */
export default async function OrderKanbanBoard({ showCancelled }: { showCancelled: boolean }) {
      ...
      <PageHeader
        ...
        action={
          <div className="flex items-center gap-2">
            ...
            <Link
              href={showCancelled ? '/admin/orders?view=board' : '/admin/orders?view=board&cancelled=1'}
